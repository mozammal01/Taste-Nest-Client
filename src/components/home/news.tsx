  ...
  return (
    <>
        ...
        >
          ...
          >
            <Link 
              ...
              className="flex flex-col md:flex-row gap-8 items-center bg-white dark:bg-slate-900 p-6 rounded-[32px] border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-100/50 dark:shadow-none transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 group"
            >
      ...
      <motion.div 
        ...
        className="container mx-auto mb-32 px-6"
      >
        <div className="relative h-[300px] md:h-[400px] rounded-[48px] overflow-hidden bg-slate-950 flex flex-col items-center justify-center text-center px-6">
          ...
          <div className="relative z-10 space-y-8">
            ...
            >
              <Link href="/under-construction">
                <AnimatedButton variant="ripple" className="rounded-full px-12 h-14 text-base">
                  Follow Us
                </AnimatedButton>
              </Link>
            </motion.div>
