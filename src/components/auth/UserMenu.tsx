        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-25 bottom-0 mb-2 lg:bottom-auto lg:top-full lg:mt-2 w-72 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 z-50 overflow-y-auto max-h-[80vh] lg:max-h-[calc(100vh-100px)]"
            >
              {/* User Info Header */}
