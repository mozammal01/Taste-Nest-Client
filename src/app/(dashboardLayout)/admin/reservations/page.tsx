      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1">
          <div className="flex items-center gap-2 mb-1">
             ...
             <span className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Admin Control</span>
          </div>
          <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">
            Reservation <span className="text-primary italic">Central</span>
          </h1>
          <p className="text-slate-500 font-medium">Global oversight of all restaurant table bookings.</p>
        </div>
